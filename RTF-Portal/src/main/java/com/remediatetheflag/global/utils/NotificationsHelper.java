...
public class NotificationsHelper {
	...
	public boolean newFeedbackReceived(User user, ExerciseInstance instance){
		...
		for(User u : admins){
			...
			n.setDateEnd(c.getTime());
			n.setIdUser(u.getIdUser());
			String link = Constants.NOTIFICATION_LINK_FEEDBACK_ADDED.replace("{EXERCISE}",String.valueOf(instance.getIdExerciseInstance()));
			n.setLink(link);
	...
	public boolean newScoringComment(User user, ExerciseInstance instance){
		...
		for(User u : admins){
			...
			n.setDateEnd(c.getTime());
			n.setIdUser(u.getIdUser());
			String link = Constants.NOTIFICATION_LINK_SCORING_COMMENT_ADDED.replace("{EXERCISE}",String.valueOf(instance.getIdExerciseInstance()));
			n.setLink(link);

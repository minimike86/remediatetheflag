...
public class Constants {
	...
	public static final Integer ROLE_RTF_ADMIN = -1;
	...
	//notifications
	public static final String NOTIFICATION_TEXT_UPDATED_REVIEW = "The review for exercise {EXERCISE} has been updated, check your results and leave a feedback.";
	...
	public static final String NOTIFICATION_LINK_COMPLETED_REVIEW = "#/history";
		...
		public static final String NOTIFICATION_LINK_SCORING_COMMENT_ADDED = "#/exercises/details/{EXERCISE}";
		public static final String NOTIFICATION_TEXT_SCORING_COMMENT_ADDED = "User {USERNAME} commented score for exercise {EXERCISE}.";
		public static final String NOTIFICATION_LINK_FEEDBACK_ADDED = "#/exercises/details/{EXERCISE}";
		...
		public static final String EXERCISE_LOG_GROUP = "RTF-Instances";

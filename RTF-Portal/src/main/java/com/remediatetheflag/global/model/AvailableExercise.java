...
public class AvailableExercise implements Serializable{
	...
	@SerializedName("referenceFileAvailable")
	@Expose
	@Column(name = "referenceFileAvailable")
	private Boolean referenceFileAvailable;
	...
	public Boolean getReferenceFileAvailable() {
		return referenceFileAvailable;
	}

	public void setReferenceFileAvailable(Boolean referenceFileAvailable) {
		this.referenceFileAvailable = referenceFileAvailable;
	}

...
public class ReviewerController extends ActionsController {
	...
	public ReviewerController(){
		...
		type2action.put("updateUserStatus", com.remediatetheflag.global.actions.auth.management.reviewer.UpdateUserStatusAction.class);
		type2fieldValidator.put(com.remediatetheflag.global.actions.auth.management.reviewer.UpdateUserStatusAction.class, new HashMap<String, Class[]>() {{
			put(Constants.ACTION_PARAM_USERNAME, new Class[]{
					com.remediatetheflag.global.actions.validators.ValidatorStringNotEmpty.class,
			}
					);

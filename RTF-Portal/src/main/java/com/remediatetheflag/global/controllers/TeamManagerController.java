...
public class TeamManagerController  extends ActionsController {
	...
	public TeamManagerController() {		
		...
		type2action.put("updateExerciseResult", com.remediatetheflag.global.actions.auth.management.team.UpdateFlagQuestionResultAction.class);
		type2fieldValidator.put(com.remediatetheflag.global.actions.auth.management.team.UpdateFlagQuestionResultAction.class, new HashMap<String, Class[]>() {{
			put(Constants.ACTION_PARAM_ID, new Class[]{
					com.remediatetheflag.global.actions.validators.ValidatorInteger.class
			}
					);
		...
		type2action.put("addResultComment", com.remediatetheflag.global.actions.auth.management.team.AddResultCommentAction.class);
		type2fieldValidator.put(com.remediatetheflag.global.actions.auth.management.team.AddResultCommentAction.class, new HashMap<String, Class[]>() {{
			put(Constants.ACTION_PARAM_ID, new Class[]{
					com.remediatetheflag.global.actions.validators.ValidatorInteger.class
			}
					);
		...
		type2action.put("updateChallenge", com.remediatetheflag.global.actions.auth.management.team.UpdateChallengeAction.class);
		type2fieldValidator.put(com.remediatetheflag.global.actions.auth.management.team.UpdateChallengeAction.class, new HashMap<String, Class[]>() {{
			put(Constants.ACTION_PARAM_NAME, new Class[]{
					com.remediatetheflag.global.actions.validators.ValidatorStringNotEmpty.class
			}
					);
		...
		type2action.put("addChallenge", com.remediatetheflag.global.actions.auth.management.team.AddChallengeAction.class);
		type2fieldValidator.put(com.remediatetheflag.global.actions.auth.management.team.AddChallengeAction.class, new HashMap<String, Class[]>() {{
			put(Constants.ACTION_PARAM_NAME, new Class[]{
					com.remediatetheflag.global.actions.validators.ValidatorStringNotEmpty.class
			}
					);
		...
		type2action.put("checkChallengeNameAvailable", com.remediatetheflag.global.actions.auth.management.team.CheckChallengeNameAvailable.class);
		type2fieldValidator.put(com.remediatetheflag.global.actions.auth.management.team.CheckChallengeNameAvailable.class, new HashMap<String, Class[]>() {{
			put(Constants.ACTION_PARAM_NAME, new Class[]{
					com.remediatetheflag.global.actions.validators.ValidatorStringNotEmpty.class
			}
					);
		...
		type2action.put("getUsersInOrg", com.remediatetheflag.global.actions.auth.management.team.GetUsersInOrganization.class);
		type2fieldValidator.put(com.remediatetheflag.global.actions.auth.management.team.GetUsersInOrganization.class, new HashMap<String, Class[]>() {{

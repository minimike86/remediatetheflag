...
public class GetExerciseHistoryDetailsAction extends IAction{
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(null!=instance){
			if(instance.isResultsAvailable() || (null!=instance.getScoring() && !instance.getScoring().equals(ExerciseScoringMode.MANUAL_REVIEW))) {

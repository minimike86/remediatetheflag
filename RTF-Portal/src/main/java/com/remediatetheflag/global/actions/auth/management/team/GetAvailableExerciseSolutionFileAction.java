...
public class GetAvailableExerciseSolutionFileAction extends IAction{
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		AvailableExercise exercise =  hpc.getAvailableExerciseWithSolution(idExercise);	
		if(null!=exercise && null!=exercise.getSolutionFile() && null!=exercise.getSolutionFile().getFile()){
			MessageGenerator.sendExerciseSolutionFileMessage(exercise.getSolutionFile(),response);
		}else{

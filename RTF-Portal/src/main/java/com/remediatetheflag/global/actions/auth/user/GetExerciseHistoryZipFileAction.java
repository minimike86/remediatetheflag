...
public class GetExerciseHistoryZipFileAction extends IAction {
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ExerciseInstance instance =  hpc.getCompletedExerciseInstanceWithFileForUser(sessionUser.getIdUser(),idExercise);	
		if(null!=instance){

 ...
 * 
 */
package com.remediatetheflag.portal.persistence;
...
import com.remediatetheflag.portal.model.AvailableExercisesForOrganization;
import com.remediatetheflag.portal.model.Challenge;
import com.remediatetheflag.portal.model.ChallengeStatus;
import com.remediatetheflag.portal.model.Country;
...
import com.remediatetheflag.portal.model.InvitationCodeForOrganization;
import com.remediatetheflag.portal.model.Notification;
...
import com.remediatetheflag.portal.model.RTFECSTaskDefinitionForExerciseInRegion;
import com.remediatetheflag.portal.model.RTFGateway;
import com.remediatetheflag.portal.model.RTFInstanceReservation;
import com.remediatetheflag.portal.model.SupportedAWSRegion;
...
import com.remediatetheflag.portal.model.UserFailedLogins;
import com.remediatetheflag.portal.model.UserStatus;
import com.remediatetheflag.portal.utils.Constants;
import com.remediatetheflag.portal.utils.RandomGenerator;
...
public class HibernatePersistenceFacade {
	...
	@SuppressWarnings("unchecked")
	public List<AvailableExercise> getAllAvailableExercises(Organization organization){
		HibernateSessionTransactionWrapper hb = openSessionTransaction();
		LinkedList<Integer> orgList = new LinkedList<Integer>();
	...
	public AvailableExercise getAvailableExerciseDetails(Integer exerciseId) {
		HibernateSessionTransactionWrapper hb = openSessionTransaction();
		AvailableExercise exercise = hb.localSession.get( AvailableExercise.class, exerciseId );
		if(null==exercise || (!exercise.getStatus().equals(AvailableExerciseStatus.AVAILABLE) && !exercise.getStatus().equals(AvailableExerciseStatus.SUPERSEDED) && !exercise.getStatus().equals(AvailableExerciseStatus.UPDATED))){
			return null;
		}
		for(AvailableExerciseInfo i : exercise.getInfoList()){
			Hibernate.initialize(i);
	...
	public List<RTFECSTaskDefinitionForExerciseInRegion> getAllTaskDefinitionsForExercise(Integer idExercise, Organization org) {
		if(isExerciseEnabledForOrganization(org.getId(),idExercise)) {
			return getAllTaskDefinitionsForExercise(idExercise);
		}
		return new LinkedList<RTFECSTaskDefinitionForExerciseInRegion>();
	}
	@SuppressWarnings("unchecked")

...
public class GetAvailableExerciseDetailsAction extends IAction{
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		AvailableExercise exercise =  hpc.getAvailableExerciseDetails(idExercise,sessionUser.getDefaultOrganization());
		if(null!=exercise)

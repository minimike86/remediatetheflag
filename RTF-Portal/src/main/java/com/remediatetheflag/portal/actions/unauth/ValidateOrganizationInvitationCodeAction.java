...
public class ValidateOrganizationInvitationCodeAction extends IAction {
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (org != null) {
			MessageGenerator.sendCodeValid(true, response);
		} else {
			MessageGenerator.sendCodeValid(false, response);
		}
	}
}
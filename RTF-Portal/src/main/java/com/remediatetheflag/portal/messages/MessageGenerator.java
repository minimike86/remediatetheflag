 ...
 * 
 */
package com.remediatetheflag.portal.messages;
...
import com.remediatetheflag.portal.messages.annotations.LazilyHint;
...
import com.remediatetheflag.portal.messages.annotations.MemberUser;
import com.remediatetheflag.portal.messages.annotations.TeamManager;
import com.remediatetheflag.portal.messages.annotations.UserStatusList;
import com.remediatetheflag.portal.model.Achievements;
...
import com.remediatetheflag.portal.model.CompletedReview;
...
import com.remediatetheflag.portal.model.PendingReview;
...
import com.remediatetheflag.portal.model.TeamLeaderboard;
...
public class MessageGenerator {
	...
	public static void sendUpdatedExerciseId(Integer idNewExercise, HttpServletResponse response) {
		JsonObject msg = new JsonObject();
		msg.addProperty(Constants.JSON_ATTRIBUTE_RESULT, idNewExercise);
		send(msg.toString(), response);
	}
}
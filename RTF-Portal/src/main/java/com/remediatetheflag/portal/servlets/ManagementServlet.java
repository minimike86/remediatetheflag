...
import com.remediatetheflag.portal.controllers.ManagementController;

public class ManagementServlet  extends HttpServlet  {

	private static final long serialVersionUID = 4338338979709967047L;
	
	private static Logger logger = LoggerFactory.getLogger(ManagementServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			logger.error("ManagementServlet Error: "+e1.getMessage());
		}
	}
}
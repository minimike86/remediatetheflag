...
public class UpdateExerciseAction extends IAction {
	...
	public void doAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		AvailableExercise exercise = hpc.getAvailableExerciseComplete(idExerciseElement.getAsInt());
		...
		exercise.getTrophy().setDescription(trophyDescriptionElement.getAsString());
		exercise.getTrophy().setName(trophyTitleElement.getAsString());
		exercise.getTrophy().setTechnology(exercise.getTechnology());
		...
		Integer id = hpc.updateAvailableExercise(exercise);
		if(null!=id)
